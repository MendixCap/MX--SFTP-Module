...
public class UserActionsRegistrar implements EventHandler
{
	...
	public void handleEvent(Event event)
	{
		if (event.getTopic().equals(com.mendix.core.event.EventConstants.ModelLoadedTopic()))        
		{
			...
			component.actionRegistry().registerUserAction(sftpconnection.actions.DisconnectIdleSessions.class);
			component.actionRegistry().registerUserAction(sftpconnection.actions.GenerateKeyPair.class);
			component.actionRegistry().registerUserAction(sftpconnection.actions.GetFileDocumentFromSFTPLocation.class);
			component.actionRegistry().registerUserAction(sftpconnection.actions.GetFileListFromSFTPLocation.class);
			component.actionRegistry().registerUserAction(sftpconnection.actions.SendFileDocumentToSFTPLocation.class);
			component.actionRegistry().registerUserAction(sftpconnection.actions.SetKnownHosts.class);
