...
public class FileDocument
{
	...
	public static system.proxies.FileDocument initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		...
		if (com.mendix.core.Core.isSubClassOf("SFTPConnection.KnownHosts", mendixObject.getType()))
			return sftpconnection.proxies.KnownHosts.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SFTPConnection.PrivateKey", mendixObject.getType()))
			return sftpconnection.proxies.PrivateKey.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SFTPConnection.PrivateKeyConnection", mendixObject.getType()))
			return sftpconnection.proxies.PrivateKeyConnection.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("SFTPConnection.PublicKey", mendixObject.getType()))
